...
<ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu2">נגזרים/הפרשי חוזים</a></li>
</ul>
...
<section id="contact" class="container">
    ...
    <p class="text-center"><em>!תודה רבה שהגעתם</em></p>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <textarea class="form-control" id="comments" name="comments" placeholder="תוכן" rows="5"></textarea>
            <br>
            <div class="row">
                <div class="col-md-12 form-group">
                    <button class="btn pull-right bg-primary" type="submit">Send</button>
                </div>
            </div>
        </div>
    </div>
